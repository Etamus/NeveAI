...
export const importConfig = async (token: string, config) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/import`, {
		method: 'POST',
		headers: {
...
export const exportConfig = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/export`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getConnectionsConfig = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/connections`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getToolServerConnections = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/tool_servers`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getTerminalServerConnections = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/terminal_servers`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const verifyToolServerConnection = async (token: string, connection: object) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/tool_servers/verify`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const registerOAuthClient = async (
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/oauth/clients/register${searchParams}`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getOAuthClientAuthorizationUrl = (clientId: string, type: null | string = null) => {
	...
	return `${NEVEAI_BASE_URL}/oauth/clients/${oauthClientId}/authorize`;
};

export const getCodeExecutionConfig = async (token: string) => {
	let error = null;

	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/code_execution`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getModelsConfig = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/models`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const setDefaultPromptSuggestions = async (token: string, promptSuggestions: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/suggestions`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getBanners = async (token: string): Promise<Banner[]> => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/configs/banners`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
