...
export const createNewChat = async (token: string, chat: object, folderId: string | null) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/new`, {
		method: 'POST',
		headers: {
...
export const unarchiveAllChats = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/unarchive/all`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const importChats = async (token: string, chats: object[]) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/import`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatList = async (
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatListByUserId = async (
	...
	const res = await fetch(
		`${NEVEAI_API_BASE_URL}/chats/list/user/${userId}?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getArchivedChatList = async (
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/archived?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getSharedChatList = async (token: string = '', page: number = 1, filter?: object) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/shared?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAllChats = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/all`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatListBySearchText = async (token: string, text: string, page: number = 1) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/search?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatsByFolderId = async (token: string, folderId: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/folder/${folderId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatListByFolderId = async (token: string, folderId: string, page: number = 1) => {
	...
	const res = await fetch(
		`${NEVEAI_API_BASE_URL}/chats/folder/${folderId}/list?${searchParams.toString()}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const getAllArchivedChats = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/all/archived`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAllUserChats = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/all/db`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAllTags = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/all/tags`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getPinnedChatList = async (token: string = '') => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/pinned`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatListByTagName = async (token: string = '', tagName: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/tags`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatByShareId = async (token: string, share_id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/share/${share_id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getChatPinnedStatusById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/pinned`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const toggleChatPinnedStatusById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/pin`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const cloneChatById = async (token: string, id: string, title?: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/clone`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const cloneSharedChatById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/clone/shared`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const shareChatById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/share`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateChatFolderIdById = async (token: string, id: string, folderId?: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/folder`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const archiveChatById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/archive`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getTagsById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/tags`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteTagsById = async (token: string, id: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/${id}/tags/all`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteAllChats = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const archiveAllChats = async (token: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/archive/all`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const exportChatStats = async (token: string, page: number = 1, params: object = {}) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/stats/export?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const exportSingleChatStats = async (token: string, chatId: string) => {
	...
	const res = await fetch(`${NEVEAI_API_BASE_URL}/chats/stats/export/${chatId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const downloadChatStats = async (
	...
	let url = `${NEVEAI_API_BASE_URL}/chats/stats/export?stream=true`;
