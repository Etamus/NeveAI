<script lang="ts">
	...
	import { NEVEAI_NAME, config, user, showSidebar } from '$lib/stores';
...
> 
> - 👉 **[Click here to learn more about enterprise licensing](https://github.com/Etamus/NeveAI)**
> - 👉 *[Click here to sponsor the project on GitHub](https://github.com/sponsors/Etamus)*
`}
			/>
		</div>
	{/if}
