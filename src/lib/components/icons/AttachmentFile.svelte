<script lang="ts">
	...
	$: extension = (name ?? '').toLowerCase().split('.').at(-1) ?? '';
...
<span class="inline-flex shrink-0 {colorClass}" aria-hidden="true">
	{#if kind === 'note'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class={className}>
			<path d="M6.5 3.75h11a1.75 1.75 0 0 1 1.75 1.75v8.75l-5 5H6.5a1.75 1.75 0 0 1-1.75-1.75v-12A1.75 1.75 0 0 1 6.5 3.75Z" />
			<path d="M14.25 19.25v-3.5a1.5 1.5 0 0 1 1.5-1.5h3.5M8.25 8h7.5M8.25 11h5.5" />
		</svg>
	{:else if kind === 'spreadsheet'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" class={className}>
	...
	{:else if kind === 'pdf'}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" class={className}>
			<path d="M6.75 3.25h7.1l3.4 3.4v14.1H6.75a2 2 0 0 1-2-2V5.25a2 2 0 0 1 2-2Z" />
			<path d="M13.75 3.5v3.25h3.25M7.5 16.75c2.3-3.8 3.35-6.2 3.1-7.1-.45-1.6-1.4 1.2.25 3.55 1.25 1.8 3.55 2.65 4.15 1.45.45-.9-2.5-1.05-7.5 2.1Z" />
		</svg>
	{:else}
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" class={className}>
			<path d="M6.75 3.25h7.1l3.4 3.4v14.1H6.75a2 2 0 0 1-2-2V5.25a2 2 0 0 1 2-2Z" />
