<script lang="ts">
	...
	export let imageUrls = [
		`${NEVEAI_BASE_URL}/assets/images/adam.jpg`,
		`${NEVEAI_BASE_URL}/assets/images/galaxy.jpg`,
		`${NEVEAI_BASE_URL}/assets/images/earth.jpg`,
		`${NEVEAI_BASE_URL}/assets/images/space.jpg`
	];
