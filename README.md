...
- **Geração e edição de imagens local** com Neve Image 1, Neve Image 1.4 (estilos e resoluções selecionáveis) e Neve Image 2 nos modos Qualidade (até 10 imagens de referência) e Rápido (ComfyUI isolado, Turbo em 6 passos, até 3 referências)
...
O modo Rápido do Neve Image 2 baixa os pesos na primeira utilização e usa ComfyUI com CUDA e o LoRA. Em AMD no Windows, a seleção usa o modo Qualidade pelo backend Vulkan como fallback compatível (sem aceleração de 6 passos).
